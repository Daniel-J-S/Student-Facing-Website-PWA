...
Django should have been installed during [Installfest Phase 4](/capstone-week/day-1/lecture-materials/installfest-phase-4).  
...
## Build Django's Official Tutorial App (Part 1)
...
As we work through the tutorial together, I'll be sure to draw analogies to the other web framework(s) you've used whenever possible.
